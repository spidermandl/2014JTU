...
import com.minor.water.bean.City;
import com.minor.water.db.DBHelper;
import com.minor.water.view.MyLetterListView;
import com.minor.water.view.MyLetterListView.OnTouchingLetterChangedListener;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Toast.makeText(getApplicationContext(), allCity_lists.get(arg2).getName(), 0).show();
		...
		//===========================================================================			
					...
					shViewHolder.editText.addTextChangedListener(new TextWatcher() {
						...
						public void afterTextChanged(Editable s) {
							...
							DBHelper db = new DBHelper(ChangeCityActivity.this);
							Cursor cursor = db.checkDB.query("city",new String[]{"name"},
